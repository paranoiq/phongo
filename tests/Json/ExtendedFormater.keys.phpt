...
use Phongo\Json\ExtendedFormater;
...
$serialiser = new Serialiser(new ExtendedFormater(FALSE, FALSE));
...
------EXPECT------
{
    ...
    id: { $oid: "1234567890ABCDEF12345678" },
    ref: { $ref: "Coll-1", $id: "1234567890ABCDEF12345678" },
    date: { $date: "2010-08-19 14:09:00" },
    regex: { $regex: "^[0-9a-f]+$", $options: "i" },
